          ...
          <div className="lg:mt-[15%]">
              ...
              <div className={`mt-[2em] flex flex-row gap-[0.8em] max-md:justify-center`}>
                <Link href="https://github.com/Salthof28" className={`md:border-[0.1em] md:border-[#FEE2D4] flex flex-row items-center md:p-[clamp(0.4em,0.4vw,0.6em)] gap-[0.2em] rounded-[1em]`}>
                  <svg stroke="currentColor" fill="#FEE2D4" stroke-width="0" viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg" className={`h-[clamp(1.4em,1vw,1.6em)] w-[clamp(1.4em,1vw,1.6em)]`}>
