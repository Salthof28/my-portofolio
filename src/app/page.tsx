...
export default function Home() {
  ...
  return (
    <div className="w-full flex flex-col items-center min-h-screen overflow-x-hidden">
      ...
      <main>
        {/* home hello */}
        <section className="flex flex-col-reverse lg:flex-row bg-[#270D01] w-screen max-md:py-[2rem] md:min-h-screen justify-center lg:justify-between gap-[2rem] 2xl:gap-[8rem] px-[12%] lg:pt-[4rem] 2xl:pt-[2rem]">
