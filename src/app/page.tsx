      ...
      <main>
        ...
        <section id="home" className="flex flex-col-reverse lg:flex-row bg-[#270D01] w-screen max-md:py-[2rem] min-h-screen justify-center lg:justify-between gap-[2rem] 2xl:gap-[8rem] px-[12%] lg:pt-[14rem] xl:pt-[4rem] 2xl:pt-[2rem]">
          <div className="lg:mt-[15%]">
              ...
              <div className={`mt-[2em] flex flex-row gap-[0.8em] max-md:justify-center`}>
                <Link href="https://github.com/Salthof28" className={`md:border-[0.1em] md:border-[#ffffff] flex flex-row items-center md:p-[clamp(0.4em,0.4vw,0.6em)] gap-[0.2em] rounded-[1em]`}>
                  ...
                  <p className={`text-[#ffffff] text-[1em] ${inter.className} text-[clamp(0.8em,0.7vw,1em)] max-md:hidden`}>GitHub</p>
                </Link>

                <Link className={`md:border-[0.1em] md:border-[#ffffff] flex flex-row items-center md:p-[clamp(0.4em,0.4vw,0.6em)] gap-[0.2em] rounded-[1em]`} href="https://www.linkedin.com/in/salman-althof-241209238">
                  <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg" className={`h-[1.6em] w-[1.6em]`}>
                    <path d="M416 32H31.9C14.3 32 0 46.5 0 64.3v383.4C0 465.5 14.3 480 31.9 480H416c17.6 0 32-14.5 32-32.3V64.3c0-17.8-14.4-32.3-32-32.3zM135.4 416H69V202.2h66.5V416zm-33.2-243c-21.3 0-38.5-17.3-38.5-38.5S80.9 96 102.2 96c21.2 0 38.5 17.3 38.5 38.5 0 21.3-17.2 38.5-38.5 38.5zm282.1 243h-66.4V312c0-24.8-.5-56.7-34.5-56.7-34.6 0-39.9 27-39.9 54.9V416h-66.4V202.2h63.7v29.2h.9c8.9-16.8 30.6-34.5 62.9-34.5 67.2 0 79.7 44.3 79.7 101.9V416z"></path>
                  </svg>
                  <p className={`text-[#ffffff] text-[1em] ${inter.className} text-[clamp(0.8em,0.7vw,1em)] max-md:hidden`}>Linkedln</p>
                </Link>

                <Link href="https://wa.me/6282120018395" className={`md:border-[0.1em] md:border-[#ffffff] flex flex-row items-center md:p-[clamp(0.4em,0.4vw,0.6em)] gap-[0.2em] rounded-[1em]`}>
                  ...
                  <p className={`text-[#ffffff] text-[1em] ${inter.className} text-[clamp(0.8em,0.7vw,1em)] max-md:hidden`}>WhatsApp</p>
                </Link>
                <Link href={`mailto:${process.env.NEXT_PUBLIC_FORMSUBMIT_EMAIL}`} className={`md:border-[0.1em] md:border-[#ffffff] flex flex-row items-center md:p-[clamp(0.4em,0.4vw,0.6em)] gap-[0.2em] rounded-[1em]`}>
                  <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" aria-hidden="true" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg" className={`h-[1.6em] w-[1.6em]`}>
                  ...
                  <p className={`text-[#ffffff] text-[1em] ${inter.className} text-[clamp(0.8em,0.7vw,1em)] max-md:hidden`}>Email</p>
                </Link>
              </div>
          </div>
